...
import com.apsaraconsulting.skyvvaadapter.api.FieldsToNullPropertyFilter;
...
/**
 * Factory class for creating {@linkplain ObjectMapper}
 */
public abstract class JsonUtils {
    ...
    public static String getBasicApiJsonSchema() throws JsonProcessingException {
        ...
        schemaClasses.addAll(packageScanClassResolver.findByFilter(
                ...
                "com.apsaraconsulting.skyvvadapter.api.dto"));
