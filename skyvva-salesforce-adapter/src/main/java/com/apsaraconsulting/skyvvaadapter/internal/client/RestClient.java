...
public interface RestClient {
     ...
     * @param requestPayload    optional input DTO for POST, etc. may be null.
     * @param headers       additional HTTP headers to send
     * @param callback      {@link ResponseCallback} to handle response or exception
     */
    void apexCall(String httpMethod, String apexUrl, Map<String, Object> queryParams, byte[] requestPayload,
